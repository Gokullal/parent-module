...
$sql = "select Student_Name,Marksheet_ID,Roll_No,Academic_Year,Course_Name,Semester,Mark_Sheet from Students_Marksheet where Roll_No= $Roll_No AND Academic_Year='$Academic_Year' AND Course_Name='$Course_Name'";
                    ...
                    <div class="data_div">
                        ...
                        <table class="data_tbl">
                            <tr class="data_tbl_tr" id="tr_odd">
                                <td class="data_tbl_td_label">Marksheet ID</td><td class="data_tbl_td_value"><?php echo $row["Marksheet_ID"]; ?></td>
                            </tr>
                             <tr class="data_tbl_tr" id="tr_even">
                                <td class="data_tbl_td_label">Roll Number</td><td class="data_tbl_td_value"><?php echo $row["Roll_No"]; ?></td>
                            </tr>
                             <tr class="data_tbl_tr" id="tr_odd">
                                <td class="data_tbl_td_label">Academic Year</td><td class="data_tbl_td_value"><?php echo $row["Academic_Year"]; ?></td>
                            </tr>
                             <tr class="data_tbl_tr" id="tr_even">
                                <td class="data_tbl_td_label">Course Name</td><td class="data_tbl_td_value"><?php echo $row["Course_Name"]; ?></td>
                            </tr>
                             <tr class="data_tbl_tr" id="tr_odd">
                                <td class="data_tbl_td_label">Semester</td><td class="data_tbl_td_value"><?php echo $row["Semester"]; ?></td>
                            </tr>
                             <tr class="data_tbl_tr" id="tr_even">
                                <td class="data_tbl_td_label">Marksheet</td><td class="data_tbl_td_value"><a href="<?php echo $row["Mark_Sheet"]; ?>">click here</a></td>
                            </tr>
                        </table>
                    </div>
